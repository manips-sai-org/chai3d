...
#define PNG_ROWBYTES(pixel_bits, width) \
    ((pixel_bits) >= 8 ? ((png_size_t)(width) * (((png_size_t)(pixel_bits)) >> 3)) : ((((png_size_t)(width) * ((png_size_t)(pixel_bits))) + 7) >> 3))
...
#define png_fixed(png_ptr, fp, s) ((fp) <= 21474 && (fp) >= -21474 ? ((png_fixed_point)(100000 * (fp))) : (png_fixed_error(png_ptr, s), 0))
#else
...
/* Decompress data in a chunk that uses compression */
    ...
    PNG_EXTERN void png_write_cHRM_fixed PNGARG((png_structp png_ptr,
                                                 ...
                                                 png_fixed_point int_red_x, png_fixed_point int_red_y, png_fixed_point int_green_x, png_fixed_point int_green_y, png_fixed_point int_blue_x,
